...
(本WebUI基于Qwen-VL-Chat打造，实现聊天机器人功能。)</center>""")
        gr.Markdown("""\
<center><font size=4>Qwen-VL <a href="https://modelscope.cn/models/qwen/Qwen-VL/summary">🤖 </a> | <a href="https://huggingface.co/Qwen/Qwen-VL">🤗</a>&nbsp ｜ Qwen-VL-Chat <a href="https://modelscope.cn/models/qwen/Qwen-VL-Chat/summary">🤖 </a> | <a href="https://huggingface.co/Qwen/Qwen-VL-Chat">🤗</a>&nbsp ｜ &nbsp<a href="https://github.com/QwenLM/Qwen-VL">Github</a></center>""")
...
def main():
    ...
    # Process images in a specific folder (use an appropriate path)
    folder_path = 'path/to/your/folder'
    output_csv = 'results.csv'
    task_history = []

    # Process images and save results
    image_results = process_images_in_folder(folder_path, task_history, model, tokenizer)
    save_results_to_csv(image_results, output_csv)
